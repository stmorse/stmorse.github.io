...
This sparse input vector thing I haven't seen elsewhere, and it does seem weird.  It seems strange that you could encode the entire dataset with $$y_i=1$$, and it seems strange that the effective space of the input data is strictly less than the original dimension.  For example, 
